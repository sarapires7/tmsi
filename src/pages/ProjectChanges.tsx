...
import { Container, Typography, Box, TextField, Breadcrumbs } from '@mui/material';
    ...
    <AppLayout>
      <Container>
        ...
        <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2 }}>
          ...
          <Typography color="text.primary">Changes</Typography>
        </Breadcrumbs>
        ...
        {changes && changes.map((change: any) => (
          <AccordionItems 
            ...
            onDelete={() => handleDeleteChange(change.id)} // Ajuste a função para deletar
          />
        ))}
        ...
        >
          <Box sx={{ p: 2 }}>
            <TextField
              ...
              required
              error={isValid}
              helperText={isValid ? 'Please, fill the issue' : ''}
            />
          </Box>
        </GenericDialog>
      </Container>
